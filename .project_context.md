...
**Fase Actual:** Fase 5 - Implementación del Downloader (Go-Rod).
...
*   [x] Cliente API (`internal/api`): Listado de álbumes/fotos.
*   [x] Comando `sync` básico (lista items de la API).

### Pendiente (Hoja de Ruta):
*   [ ] **Fase 5 (INMEDIATO):** Implementar `internal/downloader` con Go-Rod.
