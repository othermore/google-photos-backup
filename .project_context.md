...
*   [x] **Fase 3 (Continuación):** Descarga (Gestor Robusto).
    ...
    *   [x] **Robustez y Quotas:**
        *   [x] Detección fatal de "Quota Exceeded" (URL y Modal) para detener proceso limpiamente.
        *   [x] Enforcement de idioma Inglés (`hl=en`) mediante interceptor de peticiones.
        *   [x] Corrección de creación de solicitudes (espera explícita).
        *   [x] Limpieza de entradas fantasma en historial.
        *   [x] Reducción de verbosidad.
*   [ ] **Fase 3 (Finalización):** Descomprimir.
    *   [ ] Descomprimir ZIPs.
