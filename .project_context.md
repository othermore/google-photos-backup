...
**Fase Actual:** Fase 1 (Reinicio) - Infraestructura Go-Rod y Login.
...
*   [ ] **Fase 1:** Infraestructura Go-Rod (`internal/browser`).
    *   Gestor de navegador y persistencia de sesión (cookies).
    *   Comando `configure` actualizado para login manual en navegador.
*   [ ] **Fase 2:** Automatización Takeout.
    *   Navegar a takeout.google.com.
    *   Seleccionar solo Google Photos.
    *   Solicitar exportación.
*   [ ] **Fase 3:** Descarga y Extracción.
    *   Monitorizar email o página de descargas.
    *   Descargar ZIPs.
    *   Descomprimir.
