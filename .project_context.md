...
**Fase Actual:** Fase 4 - Procesamiento y Organización.
...
*   [x] **Fase 3 (Continuación):** Descarga (Gestor Robusto).
    *   [x] Detectar exportaciones completadas ("Download" button).
    *   [x] Obtener enlaces de descarga (Parsing DOM robusto).
    *   [x] Descargar ZIPs (Soporte multi-parte y reanudación).
    *   [x] Manejo de re-autenticación (password en config).
    *   [x] Limpieza de descargas fallidas (.crdownload).
    *   [x] **Robustez y Quotas:**
        *   [x] Detección fatal de "Quota Exceeded" (URL y Modal).
        *   [x] Enforcement de idioma Inglés (`hl=en`).
        *   [x] Corrección de creación de solicitudes (espera explícita).
        *   [x] Limpieza de entradas fantasma en historial.
        *   [x] **Stall Detection**: Detección de descargas colgadas (5m) y reinicio automático.
        *   [x] **Throttling Dinámico**: Escala de 2 a 6 descargas concurrentes.
        *   [x] **Recuperación**: Auto-reseteo de fallos y cooldown de finalización.
